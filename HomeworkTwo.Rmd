...
```{r}
wizards <- c("Harry Potter", "Hermione", "Sirius", "Ginny", "Malfoy")
wizards <- c(lead = "Harry Potter", friend ="Hermione" , friend ="Ron", wife ="Ginny", rival ="Malfoy")
wizards
```
